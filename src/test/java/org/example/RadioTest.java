...
class RadioTest {
    ...
    @Test
    public void setCurrentStationRadioOverHighLimit() {

        Radio radio = new Radio (15);

        radio.setCurrentStationRadio(7);
        radio.setCurrentStationRadio(15);
        int actual = radio.getCurrentStationRadio();
        int expected = 7;
    ...
    @Test
    public void NextAfterNineHighLimit() {
        Radio radio = new Radio(15);
        radio.setCurrentStationRadio(14);
        radio.next();
        int actual = radio.getCurrentStationRadio();
        int expected = 0;
    ...
    @Test
    public void PrefPreviousZeroHighLimit() {
        Radio radio = new Radio(15);
        radio.setCurrentStationRadio(0);
        radio.prev();
        int actual = radio.getCurrentStationRadio();
